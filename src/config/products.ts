...
export const products: Product[] = [
  ...
  },
  {
    ...
    title: "Early Childhood Drawing Curriculum",
    description:
      "Structured drawing studio experiences organized by increasing material and skill complexity. Sixteen developmentally appropriate studios for the early childhood years.",
    price: "$135.00",
    image: "/images/drawing-early-childhood-curriculum.jpg",
    priceVariants: [
      { format: "Paperback", price: "$135.00", ctaLabel: "Buy Paperback $135.00" },
      { format: "Digital", price: "$72.00", ctaLabel: "Buy Digital $72.00" },
    ],
    href: "/curriculum/drawing",
    category: "curriculum",
    sku: "NOA-DRAW-EC-001",
    features: [
      "16 studio experiences",
      "Paperback OR digital PDF",
      "Materials list",
      "Designed approximately for ages 3–6",
      "Free U.S. shipping",
    ],
    ageRange: "3–6 years",
    format: "Paperback or Digital PDF",
  ...
  },
  {
    ...
    title: "Elementary Drawing Curriculum",
    description:
      "Structured drawing studio experiences organized by increasing material and skill complexity. Forty-seven sequenced studios for the elementary years.",
    price: "$155.00",
    image: "/images/drawing-elementary-curriculum.jpg",
    priceVariants: [
      { format: "Paperback", price: "$155.00", ctaLabel: "Buy Paperback $155.00" },
      { format: "Digital", price: "$97.00", ctaLabel: "Buy Digital $97.00" },
    ],
    href: "/curriculum/drawing",
    category: "curriculum",
    sku: "NOA-DRAW-EL-001",
    features: [
      "47 studio experiences",
      "Paperback OR digital PDF",
      "Materials list",
      "Designed approximately for ages 6–12",
      "Free U.S. shipping",
    ],
    ageRange: "6–12 years",
    format: "Paperback or Digital PDF",
