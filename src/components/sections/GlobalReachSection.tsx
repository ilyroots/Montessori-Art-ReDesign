...
const stats = [
  {
    ...
    value: "6+",
    label: "Continents",
    sub: "Classrooms worldwide",
  },
  {
    icon: <Users size={18} />,
    value: "1000s",
    label: "Educators",
    sub: "Trained & supported",
  },
  {
    icon: <BookOpen size={18} />,
    value: "20+",
    label: "Years",
    sub: "Of practice & research",
  },
  {
...
function WorldMapSVG({ reduced }: { reduced: boolean }) {
  return (
    ...
    >
      ...
      <g opacity="0.12" fill="currentColor" className="text-honey">
        {/* North America */}
      ...
      {!reduced && (
        <g stroke="currentColor" strokeWidth="0.5" strokeDasharray="3 6" opacity="0.2" className="text-honey">
          <motion.path
...
export function GlobalReachSection() {
  ...
  return (
    <section ref={ref} className="relative py-24 sm:py-32 lg:py-40 bg-ivory overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="relative bg-paper/60 border border-linen rounded-card p-6 sm:p-10 shadow-card">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 max-w-4xl mx-auto">
          {stats.map((stat, i) => (
            <motion.div
              key={stat.label}
              className="relative bg-paper border border-linen rounded-card p-5 sm:p-6 text-center shadow-card hover:shadow-card-hover transition-shadow duration-300"
