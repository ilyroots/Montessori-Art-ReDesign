...
const actions = [
  {
    icon: <Play size={16} />,
    label: "Get Free Art Resources",
    description: "Lessons, checklists & guides",
    href: "/free-resources",
  ...
  },
  {
    ...
    description: "Painting, drawing, clay & color",
    href: "/curriculum",
  ...
  },
  {
    ...
    description: "Art Teaching Blueprint",
    href: "/certification",
    color: "bg-creative-pink/10 text-creative-pink border-creative-pink/20",
  },
  {
    icon: <BookOpen size={16} />,
    label: "Browse the Bookstore",
    description: "Art teaching guides",
    href: "/bookstore",
