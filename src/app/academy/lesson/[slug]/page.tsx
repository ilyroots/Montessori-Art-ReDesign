...
import { getAcademyLessonBySlug, getAcademyPathBySlug, canAccessLesson } from "@/config/academyLessons";
import { isLessonComplete, markLessonComplete, getNextLessonInPath } from "@/lib/academyProgress";
