...
export default function HomePage() {
  return (
    <>
      ...
      {/* ═══════════════════════════════════════════════════════════════
          EXPLORE — Layered art material atmosphere
          ═══════════════════════════════════════════════════════════════ */}
      ...
      {/* ═══════════════════════════════════════════════════════════════
          CURRICULUM — Soft gradient + honeycomb atmosphere
          ═══════════════════════════════════════════════════════════════ */}
      ...
      {/* ═══════════════════════════════════════════════════════════════
          METHOD — Scroll-driven step progress with immersive bg
          ═══════════════════════════════════════════════════════════════ */}
      <PaperTextureBackground intensity="light" variant="warm">
        <ScrollStepProgress
          steps={methodSteps}
      ...
      {/* ═══════════════════════════════════════════════════════════════
          FINAL CTA — Dark with subtle texture
          ═══════════════════════════════════════════════════════════════ */}
